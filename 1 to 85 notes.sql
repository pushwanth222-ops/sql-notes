...
-- 29. CASE Expression
SELECT title, CASE WHEN length < 60 THEN 'Short' WHEN length <= 120 THEN 'Medium' ELSE 'Long' END AS category FROM film LIMIT 5;
...
-- 40. Analytic Functions (LAG, LEAD)
...
SELECT title, rental_rate FROM film WHERE film_id = 1;
...
-- 70. FULL OUTER JOIN (MySQL workaround)
...
DELIMITER //
CREATE FUNCTION IF NOT EXISTS rental_label(rate DECIMAL(4,2))
...
-- ============================================
-- CLEANUP (run these if you want to reset)
-- ============================================
-- DROP TABLE IF EXISTS practice_db.students;
-- DROP TABLE IF EXISTS practice_db.orders;
-- DROP TABLE IF EXISTS practice_db.test1;
-- DROP TABLE IF EXISTS practice_db.test2;
-- DROP TABLE IF EXISTS practice_db.test3;
-- DROP TABLE IF EXISTS practice_db.test4;
-- DROP TABLE IF EXISTS practice_db.test5;
-- DROP TABLE IF EXISTS practice_db.test6;
-- DROP DATABASE IF EXISTS practice_db;
-- DROP DATABASE IF EXISTS test_schema;
-- DROP FUNCTION IF EXISTS rental_label;